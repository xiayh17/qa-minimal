/**
 * Stage 04 driver: Shell / Process Execution: real side effects.
 *
 * L4 stage of the qa-minimal ladder.
 *
...
async function run(ctx) {
  ...
  const question = process.env.QA_QUESTION
    || "Read src/calculator.js, find the divide-by-zero bug, fix it by adding a guard for b === 0 that throws an Error, then run: node -e \"const c = require(\\'./src/calculator\\'); try { c.divide(1,0) } catch(e) { console.log(e.message) }\" to verify."
