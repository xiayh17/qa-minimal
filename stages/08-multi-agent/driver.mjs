 ...
 *
 * L8 stage of the qa-minimal ladder.
 *
...
async function run(ctx) {
  ...
  const question = process.env.QA_QUESTION
    || "Use the subagent tool to delegate an investigation: have a subagent read src/calculator.js, find the bug in it, and report back. Then summarize what the subagent found."
