/**
 * Stage 13 driver: MCP Client.
 *
 * L13 stage of the qa-minimal ladder.
 *
...
async function run(ctx) {
  ...
  const question = process.env.QA_QUESTION
    || "List the tools you can call right now. Are there any whose names start with mcp__demo__? Based on what you observe, explain whether the MCP client reached its configured 'demo' server and what the harness did about the failure."
