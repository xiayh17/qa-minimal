/**
 * Stage 02 driver: Agent + durable memory.
 *
 * Same as Stage 01, but the session log is flushed to JSONL on disk.
 * Supports --resume <id>: rehydrates a prior session so the model
 * "remembers" conversation from a previous process.
 */
