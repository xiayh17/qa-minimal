/**
 * Stage 12 driver: Web Access.
 *
 * L12 stage of the qa-minimal ladder.
 *
...
async function run(ctx) {
  ...
  const question = process.env.QA_QUESTION
    || "Use the web_search tool to find what the current Node.js LTS release is (version number and release date). Report the answer and cite the source URLs as markdown links."
