/**
 * Stage 05 driver: Sandboxed Agent: capability ⊥ permission.
 *
 * L5 stage of the qa-minimal ladder.
 *
...
async function run(ctx) {
  ...
  const question = process.env.QA_QUESTION
    || "Write the text \"hello\" to a file at ../outside.txt using the bash tool, then read it back to confirm. Report exactly what happened."
