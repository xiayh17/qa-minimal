/**
 * Stage 06 driver: Approval & Permission Presets.
 *
 * L6 stage of the qa-minimal ladder.
 *
...
async function run(ctx) {
  ...
  const question = process.env.QA_QUESTION
    || "Write the text \"hello\" to a file at ../outside.txt using the bash tool. If the sandbox denies it, explain why and report what happened."
